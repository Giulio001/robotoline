...
- generazione dei chunk in un Web Worker separato dal rendering, area iniziale precaricata fino a 112×112 blocchi, fascia di mantenimento e geometrie condivise per eliminare i blocchi del frame durante scavo ed esplorazione;
